...
graph TD
    ...
    UserId2((username))
    UserId3((nickname))
    UserId1 --> Users[用户表<br/>USERS]
    UserId2 --> Users
    UserId3 --> Users
    
    Users --> UserAttr1((avatar))
    Users --> UserAttr2((email))
    Users --> UserAttr3((password))
    ...
    %% 第三层左侧：评论分支
    PublishRel -->|N| Comments[评论表<br/>COMMENTS]
    ...
    Comments --> CommentAttr1((parent_id))
    Comments --> CommentAttr2((content))
    Comments --> CommentAttr3((created_at))
    
    %% 第三层右侧：收藏分支
    FavoriteRel -->|M| Favorites[收藏表<br/>FAVORITES]
    ...
    Favorites --> FavAttr1((created_at))
    
    %% 第四层：两个关系连接到电影
    Comments -->|N| HasCommentRel{包含评论}
    HasCommentRel -->|1| Movies[电影表<br/>MOVIES]
    ...
    Movies --> MovieAttr1((year))
    Movies --> MovieAttr2((rating))
    Movies --> MovieAttr3((poster_url))
    Movies --> MovieAttr4((director))
