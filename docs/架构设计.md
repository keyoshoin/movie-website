...
graph TB
    ...
    CommentUpdated((updated_at))
    
    Comments[评论表<br/>COMMENTS]
    
    CommentId --> Comments
    CommentUserId --> Comments
    CommentMovieId --> Comments
    CommentParentId --> Comments
    ...
    FavId --> Favorites
    FavUserId --> Favorites
    FavMovieId --> Favorites
    FavCreated --> Favorites
    
    %% 关系
    Users -->|1| PublishRel{发表评论}
    PublishRel -->|N| Comments
    
    Movies -->|1| HasCommentRel{包含评论}
    HasCommentRel -->|N| Comments
    
    Users -->|N| FavoriteRel{收藏电影}
    FavoriteRel -->|M| Favorites
    
    Movies -->|1| IsFavoritedRel{被收藏}
    IsFavoritedRel -->|N| Favorites
